...
public class Worker {
	...
	public double income(int year, int month) {
		...
		Calendar cal = Calendar.getInstance(); //atriguição de calendário para validação do contrato no mês e ano apropriado
		for (HourContract c: contracts) { //leitura da lista de contratos
